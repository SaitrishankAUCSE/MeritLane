...
export function Autocomplete({
  ...
  return (
    <div className="flex w-full flex-col gap-1.5 text-left relative" ref={wrapperRef}>
      ...
      {isOpen && (
        <div id={`${inputId}-listbox`} role="listbox" className="absolute top-[calc(100%+4px)] left-0 w-full max-h-[250px] overflow-y-auto bg-[#FFFFFF] border border-[#E5E5E5] rounded-md shadow-sm z-50 py-1 scrollbar-hide">
          {isLoading ? (
