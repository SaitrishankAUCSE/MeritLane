    ...
    <footer className={`border-t pt-12 pb-8 ${isPublicHome ? "border-[var(--color-border)] bg-transparent" : "border-border"}`}>
      <div className="mx-auto max-w-7xl px-5 sm:px-8 lg:px-16">
        <div className="grid grid-cols-2 gap-8 md:grid-cols-4 lg:grid-cols-5">
          ...
          <div>
            <h3 className="font-label text-outline">For Candidates</h3>
          ...
          <div>
            <h3 className="font-label text-outline">Company</h3>
            <ul className="mt-4 space-y-3 text-sm text-muted-foreground">
        ...
        <div className="mt-12 flex flex-col items-center justify-between gap-4 border-t border-border pt-8 md:flex-row">
          <p className="font-data text-outline">&copy; {new Date().getFullYear()} Meritlane</p>
        </div>
      </div>
    </footer>
  );
