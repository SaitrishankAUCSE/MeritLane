...
export default function JobDetailPage() {
  ...
  // If user is logged in as candidate, fetch their full candidate profile for real-time eligibility check
  useEffect(() => {
  ...
  if (error || !job) {
    return (
      <div className="min-h-screen bg-[#FAF8F5] flex items-center justify-center p-8 text-[#1C1917]">
        <div className="max-w-md w-full bg-white border border-[#E7E2DA] p-8 text-center rounded-2xl shadow-xs">
          ...
          <h2 className="text-[20px] font-bold uppercase tracking-[0.06em] mb-2">
          ...
          <Link href="/jobs">
            <button className="px-5 py-2.5 bg-[#1C1917] text-white text-[12px] font-mono font-semibold rounded-full hover:bg-[#064E3B] transition-colors">
              RETURN TO ROLES
            </button>
          </Link>
        </div>
  ...
  return (
    <div className="w-full min-h-screen bg-[#FAF8F5] pb-24 text-[#1C1917]">
      {/* ── Top Navigation Bar ── */}
      <div className="border-b border-[#E7E2DA] bg-white px-6 sm:px-10 py-4">
      ...
      <div className="max-w-[1200px] mx-auto px-6 sm:px-10 py-8 grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="border border-[#E7E2DA] bg-white p-7 sm:p-9 rounded-2xl shadow-xs">
            ...
            <h1 className="text-[26px] sm:text-[32px] font-bold text-[#1C1917] tracking-tight leading-tight mb-2">
              {job.title}
            </h1>
            ...
            <div className="py-6 space-y-4">
              <h2 className="text-[14px] font-bold uppercase tracking-[0.08em] text-[#1C1917]">
