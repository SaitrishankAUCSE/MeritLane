  ...
  if (!hasStarted || errorMsg) {
    return (
      <div className="flex h-full w-full items-center justify-center bg-[#0b0c0e] p-6 overflow-y-auto scrollbar-hide">
        <div className="w-full max-w-2xl border border-[#272a2f] bg-[#111316] rounded-md overflow-hidden shadow-2xl">
          ...
          <div className="border-b border-[#272a2f] px-8 py-6 flex items-center justify-between">
            ...
            {errorMsg === "ALREADY VERIFIED" || errorMsg === "VERIFICATION COMPLETE" ? (
              <span className="text-[14px] font-sans font-medium px-3 py-1.5 bg-[#a8a2ff]/10 text-[#a8a2ff] border border-[#a8a2ff]/20 rounded-md">Verified</span>
            ) : errorMsg === "ASSESSMENT NOT PASSED" ? (
              <span className="text-[14px] font-sans font-medium px-3 py-1.5 bg-red-500/10 text-red-500 border border-red-500/20 rounded-md">Failed</span>
            ) : (
              <span className="text-[14px] font-sans font-medium px-3 py-1.5 bg-[#272a2f] text-white rounded-md">Not Started</span>
            )}
          </div>
            ...
            {errorMsg === "ALREADY VERIFIED" || errorMsg === "VERIFICATION COMPLETE" ? (
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-6 mb-8">
                  ...
                  <div className="border border-[#272a2f] bg-[#0b0c0e] p-4 rounded-md">
                    <div className="text-[14px] font-sans font-medium text-[#8e928f] mb-1">Allowance</div>
                    <div className="text-[14px] font-mono text-white flex items-center gap-2">
      ...
      <div className="flex flex-1 overflow-hidden">
        <div className="w-[40%] max-w-[600px] border-r border-[#272a2f] bg-[#111316] flex flex-col z-10">
          <div className="p-6 border-b border-[#272a2f]">
            <h2 className="font-sans text-[14px] font-medium text-[#8e928f]">Problem Specification</h2>
          </div>
